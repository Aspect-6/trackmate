...
interface AssignmentKindChooserModalProps {
    onClose: () => void
}

export const AssignmentKindChooserModal: React.FC<AssignmentKindChooserModalProps> = ({ onClose }) => {
    ...
    const handleLoadTemplate = (templateId: string) => {
        ...
        if (template) {
            onClose()
            openModal("add-assignment", { templateData: template })
        }
    }

    const hasTemplates = assignmentTemplates.length > 0
                ...
                >
                    <div className="flex items-center gap-4">
                        <div
                            ...
                            style={{
                                backgroundColor: GLOBAL.ASSIGNMENT_BUTTON_BG_18,
                                color: GLOBAL.ASSIGNMENT_HEADING_TEXT
                            }}
                        >
                            <Plus size={24} />
                        </div>
                        <div className="text-left">
                            ...
                            <div className="text-sm" style={{ color: GLOBAL.TEXT_SECONDARY }}>Start with a blank assignment</div>
                        </div>
                    </div>
