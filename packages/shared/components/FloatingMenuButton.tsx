...
const FloatingMenuButton: React.FC<FloatingMenuButtonProps> = ({
    ...
    return (
        <button
            onClick={onClick}
            className={`lg:hidden fixed bottom-6 w-14 h-14 rounded-full shadow-lg inset-shadow flex items-center justify-center z-40 transition-all duration-300 ease-in-out active:scale-95`}
            style={{
